...
// const portfolioCard = document.querySelectorAll('.body-portfolio__column');

// document.querySelector('.body-portfolio__links').addEventListener('click', (event) => {

//    if (event.target.tagName !== 'li') return false;
//    let filterClass = event.target.dataset['filter'];

//    portfolioCard.forEach(elem => {
